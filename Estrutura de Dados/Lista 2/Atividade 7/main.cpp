...
int main()
{
    ...
    a[0].nome=="Aeroporto de São Paulo";
    a[1].nome=="Aeroporto do Rio de Janeiro";
    a[2].nome=="Aeroporto de Curitiba";
    a[3].nome=="Aeroporto de Salvador";
    a[4].nome=="Aeroporto de Brasilia";
